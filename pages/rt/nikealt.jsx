...
export default function Detay() {
  ...
  const handleAddToCart = () => {
    const product = {
      name: "Nike M NK DRY PARK18 PANT KPZ Erkek Eşofman Alt AA2086-451",
      size,
      price,
      imgUrl,
    };
          ...
          <div className="w-1/2 p-6">
            <div className="text-center mb-4">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Nike M NK DRY PARK18 PANT KPZ Erkek Eşofman Alt AA2086-451
              </h1>
              <p className="mb-8 text-lg text-gray-700 ">
              Yumuşak bir taşıma hissi için polar malzeme
Manşetlerde ve etekte ribana malzeme
Standart kalıp
              </p>
            </div>
