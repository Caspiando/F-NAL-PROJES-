...
export default function Detay() {
  ...
  const handleAddToCart = () => {
    const product = {
      name: "Vestel CMI 108322 Wifi 10 kg 1200 Devir Çamaşır Makinesi",
      quantity,
      price,
      imgUrl: imgUrl,
    };
  ...
  const imgUrl = "/vestel-camasir.png";
  const BeyazEsya = [
    {
          ...
          <div className="w-1/2 p-6">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Vestel CMI 108322 Wifi 10 kg 1200 Devir Çamaşır Makinesi{" "}
              </h1>
              <p className="mb-8 text-lg text-gray-700">
              10 kg
1200 Devir
A
Sessiz Inverter Motor
