...
export default function Detay() {
  ...
  const handleAddToCart = () => {
    const product = {
      name: "iPhone 14 Pro Plus 128 GB",
      storage,
      price,
      imgUrl: "/14pro.jpg",
    };
        ...
        <div className="max-w-screen-lg bg-white rounded-lg p-6 shadow-xl flex">
          <div className="w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              <img src="/14pro.jpg" alt="iPhone 14" className="w-full rounded-lg shadow-lg" />
            </div>
          </div>
          <div className="w-1/2 p-6">
            <div className="text-center mb-4">
              <h1 className="text-4xl font-bold text-gray-900 mb-2">IPHONE 14 PRO PLUS</h1>
              <p className="text-lg text-gray-700">
              6.7 inç Super Retina XDR ekran
Tüm gün süren pil ömrü ve 26 saate kadar video oynatma
...
Sorunsuz, titremeyen videolar çekmek için Hareket modu
            ...
            <div className="flex justify-center items-center mb-4">
              ...
              <span className="bg-gray-200 px-3 py-1 mx-2">{quantity}</span>
              <Button 
                sx={{ backgroundColor: 'black', color: 'blue', "&:hover": { backgroundColor: 'black', color: 'blue' } }}
            ...
            <div className="flex justify-center items-center mb-4">
              <span className="text-gray-800 text-lg font-semibold">Fiyat: {price} TL</span>
            </div>
          ...
          <div className="w-1/2 p-6 border-l border-gray-200">
            <div className="flex flex-col justify-center items-center mb-4">
              ...
              <div className="flex items-center mt-1">
                <span className="text-xl font-semibold mr-1">Puanlama:</span>
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex items-center mt-1">
                <LocalShipping className="text-blue-500 mr-1" />
