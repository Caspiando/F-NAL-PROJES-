...
export default function Detay() {
  ...
  const price = 12900;
  const productName = "Arçelik 6133 S 3 Programlı Bulaşık Makinesi";
  const imgUrl = "/arcelik-bulasik.png";
        ...
        <div className="max-w-screen-lg bg-white rounded-lg p-6 shadow-xl flex">
          ...
          <div className="w-1/2 p-6">
            <div className="text-center">
              ...
              <p className="mb-8 text-lg text-gray-700">Ürün Tipi
Solo
Ürün Rengi
Gümüş
Program Sayısı
...
NT22</p>
        ...
        <div className="mt-20">
         <span className="text-2xl text-red-700 ">İlginizi çekebilicek ürünler</span>
        </div>
        <div className="mt-5">
