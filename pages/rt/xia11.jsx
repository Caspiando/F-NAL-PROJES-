...
export default function Detay() {
  ...
  const price = 8400;
  const imgUrl = "/xiaomi-note11pro.png";
  ...
  const handleAddToCart = () => {
    const product = {
      name: "Xiaomi Note 11 Pro 256 GB",
      quantity,
      storage,
      price,
      imgUrl,
...
8 GB RAM
Renk: Mavi
6.67" inç FHD+ AMOLED ekran, 108 megapiksel profesyonel ultra geniş açılı kamera, 120 Hz yenileme hızı
67 W turbo şarj destekli 5000 mAh batarya, IP53 sıçrama dayanıklılığı
              </p>
            </div>
