...
export default function Detay() {
  ...
  const handleAddToCart = () => {
    const product = {
      name: "iPhone 13 Pro Plus 128 GB",
      quantity,
      storage: "128gb",
      price,
      imgUrl,
    ...
    const existingProductIndex = cart.findIndex(
      (item) =>
        item.name === product.name && item.storage === product.storage
    );
        ...
        <div className="max-w-screen-lg bg-white rounded-lg p-6 shadow-xl flex">
          ...
          <div className="w-1/2 p-6">
            <div className="text-center">
              ...
              iPhone Pro Plus 13. Bir iPhone’da bugüne kadar kullanılan en gelişmiş çift kamera sistemi. Işık hızında A15 Bionic çip. Pil ömründe büyük bir gelişme. Dayanıklı tasarım. Ve daha parlak bir Super Retina XDR ekran.
              </p>
            </div>
            ...
            <div className="flex justify-center items-center mb-6">
              ...
              <Button
                ...
                sx={{
                  ...
                  color: "blue",
                  "&:hover": { backgroundColor: "black", color: "blue" },
                }}
                variant="contained"
                color="secondary"
                size="small"
            ...
            <div className="flex flex-col justify-center items-center mb-6">
              ...
              <div className="flex items-center">
                ...
                <div className="border border-gray-300 rounded-md px-2 py-1 mr-2 bg-gray-200">
                  128GB
                </div>
              </div>
            </div>
