...
export default function Detay() {
  ...
  const [size, setSize] = useState("40"); // Numara seçeneği
  const price = 1100;
  const imgUrl = "/pumaayk.png";
  ...
  const handleAddToCart = () => {
    const product = {
      name: "Puma Court Classic Vulc FS Unisex Spor Ayakkabı 39635303",
      size,
      price,
      imgUrl,
    };
    ...
    // Kontrol edilerek eğer sepette aynı ürün varsa sadece adet sayısını artır
    ...
    if (existingProductIndex !== -1) {
      ...
      // Eğer sepette aynı ürün yoksa, yeni ürünü ekleyelim
        ...
        <div className="max-w-screen-lg bg-white rounded-lg p-6 shadow-xl flex">
          <div className="w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              <img
                src={imgUrl}
                alt="Puma Court Classic Vulc FS Unisex Spor Ayakkabı 39635303"
          ...
          <div className="w-1/2 p-6">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Puma Court Classic Vulc FS Unisex Spor Ayakkabı 39635303
              </h1>
              <p className="mb-8 text-lg text-gray-700">
              ZAMANSIZ TASARIM: Zahmetsiz mahkeme titreşimlerine yaslanın ve onları stil DNA'nızın bir parçası haline getirin.
GELİŞTİRİLMİŞ TEKNOLOJİ: Ekstra kalın topuğu sayesinde yumuşak yastıklama sağlamak için tasarlanmış kademeli konforlu bir çorap astarı olan PUMA'nın SoftFoam+'sını kullanır.
              </p>
            </div>
