...
export default function Detay() {
  ...
  const price = 13640;
  const imgUrl = "/xiaomi-redmi12.jpg";
          ...
          <div className="w-1/2 p-6">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                Xiaomi Redmi 12 PLUS
              </h1>
              <p className="mb-8 text-lg text-gray-700">
              Snapdragon 732G
6.67 inç FHD+ AMOLED Ekran
108 MP görüntüleme sistemi
67 W turbo şarj
Arka parmak izi sensörü
              </p>
