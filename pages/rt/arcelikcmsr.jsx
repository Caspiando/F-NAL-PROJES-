...
export default function Detay() {
  ...
  const price = 14900;
  const productName = "Arçelik 9100 DMX 1000 Devir 9 Kg A Enerji Sınıfı Çamaşır Makinesi";
  const imgUrl = "/arcelik-camasir.png";
  ...
  const handleAddToCart = () => {
    ...
    if (existingProductIndex !== -1) {
      // Eğer sepette aynı ürün varsa adedini artır
      cart[existingProductIndex].quantity += quantity;
    } else {
      // Eğer sepette yoksa yeni ürünü ekle
      const product = {
        name: productName,
        quantity: quantity,
        price: price,
        ...
        <div className="max-w-screen-lg bg-white rounded-lg p-6 shadow-xl flex">
          <div className="w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              <img src={imgUrl} alt={productName} className="w-full rounded-lg shadow-lg" />
            </div>
          </div>
...
A
            ...
            <div className="flex justify-center items-center mb-6">
              ...
              <Button onClick={handleDecrement} variant="contained" color="secondary" size="small" style={{ backgroundColor: 'black', color: 'blue' }}>
                <Remove />
              </Button>
              <span className="bg-gray-200 px-3 py-1">{quantity}</span>
              <Button onClick={handleIncrement} variant="contained" color="secondary" size="small" style={{ backgroundColor: 'black', color: 'blue' }}>
                <Add />
              </Button>
            </div>
            <div className="flex justify-center items-center mb-6">
            ...
            <div className="flex justify-center">
              <Button variant="contained" color="primary" size="large" onClick={handleAddToCart} style={{ backgroundColor: 'black', color: 'blue' }}>
                Sepete Ekle
              </Button>
            </div>
          </div>
